...
CDefineTableEntry::CDefineTableEntry(char* nname, char* nvalue, CStringList* nnss/*added*/, CDefineTableEntry* nnext) {
	char* s1, * s2;
	name = STRDUP(nname);
	if (name == NULL) {
		Error("No enough memory!", 0, FATAL);
...
void CDefineTable::Add(char* name, char* value, CStringList* nss/*added*/) {
